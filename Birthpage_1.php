...
//when the logout button is pressed the session ends 
//if the logout btn which has post method is set or clicked  destory the sessoin and go back to login page
...
<section id="proceed">
Welcome <b><?= $_SESSION['username'] ?></b>, your now loggged in. To Proceed to apply for Birth 
Certificate Online Click on 
<a href="http://localhost/CIVIL%20STATUS%20REGISTRY/Birthpage_2.php"> 
<button>Apply</button>
</a>

<p>
To get Certificate click on
<a href="BirthCertification.php" target="_new">Get Birth Certificate</a>
</section>
